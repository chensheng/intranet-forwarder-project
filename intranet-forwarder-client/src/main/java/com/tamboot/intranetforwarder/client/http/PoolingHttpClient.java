package com.tamboot.intranetforwarder.client.http;

import com.tamboot.common.tools.base.ExceptionUtil;
import com.tamboot.intranetforwarder.client.config.ClientProperties;
...
public class PoolingHttpClient {
    ...
    private ClientProperties.HttpClient config;

    private CloseableHttpClient client;

    public PoolingHttpClient(ClientProperties properties) {
        Assert.notNull(properties, "[tamboot.intranet-forwarder.client] must not be null");
        Assert.notNull(properties.getHttpclient(), "[tamboot.intranet-forwarder.client.httpclient] must not be null");
